...
@st.cache
def get_data():
    return pd.read_csv(r"C:\Users\william.prochnow\Documents\ProjetosDS\Projetos\MinerandoDados\Arquvios\data.csv")
...
# subtítulo
st.markdown("Este é um Data App utilizado para exibir a solução de Machine Learning para o problema de predição de \
             valores de imóveis de Boston.")
